...
<br>
	...
	<div>
		...
		<table style="background-color: #fc0;">
           <th>CUSTOMER ID</th>
           <th>NAME </th>
           <th>EMAIL</th>
...
<br><br>
	<h3 align=center font-family=Arial>Please Select the user you want to transfer money to from the dropdown list</h3>
	<table border="0px" style="background-color:#ffcc00;">
		<tr>
		<td>Transfer To:</td>
		<td><select name="user">
			...
			<tr><td></td><td><input type="submit" name="submit" value="Submit" align=center style="margin-top: 10px; width:6em; height:2em; font-size:15px; background-color:#dddddd; font-weight: bold;"></td></tr>
